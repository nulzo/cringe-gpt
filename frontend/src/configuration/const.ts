...
/**
 * The base endpoint for the backend API
 */
export const BASE_API = "api";

/**
 * The base API version for the backend
 */
...
/**
 * The github page for the application
 */
export const APP_GITHUB_PAGE = "https://github.com/nulzo/Ollama-WebUI";
