...
import {IconInfoCircle, IconHeart, IconClock, IconCoins, IconMessage, IconTool, IconImageInPicture, IconFile} from "@tabler/icons-react";
...
export const MessageDetails: React.FC<MessageDetailsProps> = ({
    ...
    const messageId = message.messageId || message.message_id || message.id.toString();
    const { data: details, isLoading: isDetailsLoading } = useMessageDetails(messageId);
            ...
            <PopoverContent className="w-96 max-h-96 overflow-y-auto">
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Badge variant={message.role === 'assistant' ? 'default' : 'secondary'} className="text-xs">
                            {message.role}
                        </Badge>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2 pt-2">
                            {(getTokenCount(messageData) || getGenerationTime(messageData) || getTotalCost(messageData)) && (
                        ...
                        <div className="space-y-2 pt-2">
                            ...
                            <div className="flex items-center gap-2">
                                <IconHeart className={`size-4 ${getIsLiked(messageData) ? 'text-red-500 fill-current' : 'text-muted-foreground'}`} />
