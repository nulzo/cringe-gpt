                  ...
                  >
                    <div className="flex w-full items-center gap-2">
                      ...
                      <div className="ml-auto flex shrink-0 items-center gap-1">
                        ...
                        {(item.model.tooling.supportsTools ||
                          item.model.tooling.supportsFunctionCalling) && (
                          <ModelFeatureBadge
                            icon={Wrench}
                            isSelected={isSelected}
                        ...
                        {(item.model.pricing.promptCostPerMillionTokens !==
                          undefined ||
                          item.model.pricing.completionCostPerMillionTokens !==
                            undefined) && (
                          <ModelFeatureBadge
                            isSelected={isSelected}
                            isTextBadge={true}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              size="icon"
              className={cn(
                "h-9 w-9 p-0 rounded-md bg-transparent hover:bg-hover transition-all",
              )}
...
export function ModelSelect(props: ModelSelectProps) {
  const loadingFallback = (
    <Button variant="ghost" className="h-12 w-full justify-start" disabled>
      <div className="mr-2 size-4 animate-spin rounded-full border-2 border-muted-foreground border-t-transparent" />
      Loading models...
    </Button>
  );
  return (
