...
import {IconEdit, IconPhoto, IconSparkles, IconUpload, IconX} from '@tabler/icons-react';
...
export function ImageGenerationModal({
    ...
    const handleFileUpload = (files: FileList | null, type: 'reference' | 'mask') => {
        if (!files) return;
                            ...
                            <div className="space-y-2">
                                ...
                                <ScrollArea className="h-64">
                                    <div className="grid grid-cols-2 gap-4">
                                        {imageResponse.images.map((image: ImageDto, index: number) => (
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {referenceImages.map((img, index) => (
                                        <div key={index} className="relative group">
                                            ...
                                            />
                                            <Badge
                                                variant={img.type === 'reference' ? 'default' : 'secondary'}
