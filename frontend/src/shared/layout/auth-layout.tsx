...
export const AuthLayout = ({children, title}: AuthLayoutProps) => {
    return (
        <>
            <Head title={title}/>
            <main
                className="flex flex-col place-items-center bg-background selection:bg-primary/50 px-6 lg:px-8 py-24 sm:py-32 h-screen min-h-full max-h-dvh font-inter text-foreground overflow-auto">
